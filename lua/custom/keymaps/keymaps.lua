...
key.set('n', '<leader>f', require('telescope.builtin').find_files, { desc = '[S]earch [F]iles' })
key.set('n', '<leader>p', ':lua require"telescope".extensions.project.project{}<CR>', { desc = '[S]earch [P]rojects' })
